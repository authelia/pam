...
#define PAM_AUTHELIA_DEFAULT_BINARY  "/usr/bin/pam_authelia"
...
#define CMD_PROMPT_MULTI_VISIBLE "PROMPT_MULTI_VISIBLE:"
...
/* Maximum payload size for length-prefixed multi-line prompts. */
#define MAX_PROMPT_PAYLOAD 16384
...
struct pam_authelia_config {
	const char *binary;              /* Path to pam_authelia binary.        */
